// ======================================================================
// Tec-Dig-2.v generated from TopDesign.cysch
// 07/27/2024 at 18:00
...
module ADC_DelSig_v3_30_2 (
	...
	cy_clock_v1_0
		#(.id("98e091f1-d954-410f-83e5-a70b9b4cbcba/b7604721-db56-4477-98c2-8fae77869066"),
	...
	cy_clock_v1_0
		#(.id("98e091f1-d954-410f-83e5-a70b9b4cbcba/edd15f43-b66b-457b-be3a-5342345270c8"),
		  .source_clock_id("61737EF6-3B74-48f9-8B91-F7473A442AE7"),
		  .divisor(0),
...
module top ;
	...
	wire [0:0] tmpOE__MQ2_net;
	wire [0:0] tmpFB_0__MQ2_net;
	wire [0:0] tmpIO_0__MQ2_net;
	wire [0:0] tmpINTERRUPT_0__MQ2_net;
	electrical [0:0] tmpSIOVREF__MQ2_net;
	...
	cy_psoc3_pins_v1_10
		...
		MQ2
		 (.oe(tmpOE__MQ2_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__MQ2_net[0:0]}),
		  .analog({Net_27}),
		  .io({tmpIO_0__MQ2_net[0:0]}),
		  .siovref(tmpSIOVREF__MQ2_net),
		  .interrupt({tmpINTERRUPT_0__MQ2_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__MQ2_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	wire [0:0] tmpOE__NivelMax_net;
	wire [0:0] tmpFB_0__NivelMax_net;
	wire [0:0] tmpIO_0__NivelMax_net;
	wire [0:0] tmpINTERRUPT_0__NivelMax_net;
	electrical [0:0] tmpSIOVREF__NivelMax_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("8d318d8b-cf7b-4b6b-b02c-ab1c5c49d0ba"),
		  ...
		  .input_buffer_sel(2'b00))
		NivelMax
		 (.oe(tmpOE__NivelMax_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__NivelMax_net[0:0]}),
		  .io({tmpIO_0__NivelMax_net[0:0]}),
		  .siovref(tmpSIOVREF__NivelMax_net),
		  .interrupt({tmpINTERRUPT_0__NivelMax_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__NivelMax_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Bomba_net;
	wire [0:0] tmpFB_0__Bomba_net;
	wire [0:0] tmpIO_0__Bomba_net;
	wire [0:0] tmpINTERRUPT_0__Bomba_net;
	electrical [0:0] tmpSIOVREF__Bomba_net;
	...
	cy_psoc3_pins_v1_10
		...
		Bomba
		 (.oe(tmpOE__Bomba_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Bomba_net[0:0]}),
		  .io({tmpIO_0__Bomba_net[0:0]}),
		  .siovref(tmpSIOVREF__Bomba_net),
		  .interrupt({tmpINTERRUPT_0__Bomba_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Bomba_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Cooler_net;
	wire [0:0] tmpFB_0__Cooler_net;
	wire [0:0] tmpIO_0__Cooler_net;
	wire [0:0] tmpINTERRUPT_0__Cooler_net;
	electrical [0:0] tmpSIOVREF__Cooler_net;

	cy_psoc3_pins_v1_10
		#(.id("d6e928af-7b07-4d1c-8b6e-5b1955bd4c81"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Cooler
		 (.oe(tmpOE__Cooler_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Cooler_net[0:0]}),
		  .io({tmpIO_0__Cooler_net[0:0]}),
		  .siovref(tmpSIOVREF__Cooler_net),
		  .interrupt({tmpINTERRUPT_0__Cooler_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Cooler_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	cy_psoc3_pins_v1_10
		#(.id("c955a2f9-ac4f-48f8-8a3a-4a786354a473"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("fc9d21e9-dfad-47a2-bc16-08ee8fdb4906"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_clock_v1_0
		#(.id("61de3964-03bd-4345-a6d3-81c1b83dbbed"),
		  .source_clock_id(""),
		  .divisor(0),
		  .period("1000000000"),
		  .is_direct(0),
	...
	wire [0:0] tmpOE__NivelMin_net;
	wire [0:0] tmpFB_0__NivelMin_net;
	wire [0:0] tmpIO_0__NivelMin_net;
	wire [0:0] tmpINTERRUPT_0__NivelMin_net;
	electrical [0:0] tmpSIOVREF__NivelMin_net;

	cy_psoc3_pins_v1_10
		#(.id("a18db1f1-dbd6-4e5d-a239-eb364f94f9e5"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		NivelMin
		 (.oe(tmpOE__NivelMin_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__NivelMin_net[0:0]}),
		  .io({tmpIO_0__NivelMin_net[0:0]}),
		  .siovref(tmpSIOVREF__NivelMin_net),
		  .interrupt({tmpINTERRUPT_0__NivelMin_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__NivelMin_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
