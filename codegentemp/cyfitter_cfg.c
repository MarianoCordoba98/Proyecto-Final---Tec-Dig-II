...
#define BS_IOPINS0_0_VAL ((const uint8 CYFAR *)0x48000558u)

/* IOPINS0_7 Address: CYREG_PRT12_DR Size (bytes): 10 */
#define BS_IOPINS0_7_VAL ((const uint8 CYFAR *)0x48000560u)

/* IOPINS0_8 Address: CYREG_PRT15_DM0 Size (bytes): 8 */
#define BS_IOPINS0_8_VAL ((const uint8 CYFAR *)0x4800056Cu)
...
#define BS_IOPINS0_3_VAL ((const uint8 CYFAR *)0x48000588u)
...
static void AnalogSetDefault(void)
{
	...
	CY_SET_XTND_REG8((void CYFAR *)CYREG_PRT15_AMUX, 0x10u);
	CY_SET_XTND_REG8((void CYFAR *)CYREG_DSM0_SW0, 0x80u);
	CY_SET_XTND_REG16((void CYFAR *)CYREG_OPAMP3_MX, 0x0103u);
